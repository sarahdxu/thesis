...
\hline \\[-1.8ex] 
Observations & 343 & 343 & 343 & 343 \\ 
Log Likelihood & $-$234.689 & $-$234.392 & $-$233.916 & $-$233.620 \\ 
Akaike Inf. Crit. & 473.378 & 472.785 & 483.831 & 483.239 \\ 
Pseudo-R$^{2}$ & 0.0041 & 0.00536 & 0.00740 & 0.00866 \\
MSE & 0.2287 & 0.2283 & 0.2277 & 0.2273 \\
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
