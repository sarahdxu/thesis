...
{\color{green}Figure 2a} consists of 2 panels (Panels A and B) that shows the distribution of parameters, \(\alpha\) and \(\rho\) , from responses in GDG.
...
\noindent Figure 2a: Distribution of responses in UG1, UG2, TG1, and PGG \\ 
